...
class TicTacToe
  ...
  def won?
    a = WIN_COMBINATIONS.find{|combo| @board[combo[index]] == "X" && @board[combo[index]] == "X" && @board[combo[index]] == "X"
    }

    b = WIN_COMBINATIONS.find{|combo| @board[combo[index]] == "O" && @board[combo[index]] == "O" && @board[combo[index]] == "O"
    }
